      ...
      <div class="row no-gutters">
        <div class="team">
          <div class="card-body">
            ...
            {% if card.inline == false %}<a href="{{ card.url | relative_url }}">{% endif %}
              <p class="card-text">{{ card.teaser }}<br></p></a>
            <p class="card-text">
              ...
              <small class="test-muted"><i class="fa-solid fa-diagram-predecessor"></i>Domain: {{ card.domain }}</small><br>
              <small class="test-muted"><i class="fa-solid fa-diagram-successor"></i>Subdomain: {{ card.topic }}</small><br>
          </p>
          </div>
        </div>
      </div>
