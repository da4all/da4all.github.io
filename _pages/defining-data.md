...
<p>
    <div class="card {% if card.inline == false %}hoverable{% endif %}">
        <div class="row no-gutters">
			...
			<small class="test-muted"><i class="fas fa-square-poll-vertical"></i>  Data Literacy: {{ card.profile.literacy domain | replace: '<br />', ', ' }} ; Data Literacy: {{ card.profile.subdomain | replace: '<br />', ', ' }} </small> <br>
