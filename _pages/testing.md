      ...
      <div class="row no-gutters">
        <div class="team">
          <div class="card-body">
            ...
            <p class="card-text"><small class="test-muted">{% if card.profile.date %}<i class="fa-solid fa-calendar"></i>&nbsp; Date: {{ card.profile.date | replace: '<br />', ', ' }}<br>
            ...
            <p class="card-text"><br>
              ...
              <small class="test-muted group"><i class="fa-solid fa-quote-left"></i>&nbsp; License: {{ card.profile.license }}</small><br>
            </p>
          </div>
        </div>
      </div>
