      ...
      <div class="row no-gutters">
        <div class="team">
          <div class="card-body">
            ...
            {% endif %}
            <p class="card-text">
              {% if card.profile.source %}<small class="test-muted"><i class="{{ resource.icon | default: 'fas fa-file' }}"></i> Source: <a href="{{ card.profile.source }}">{{ card.profile.source | replace: '<br />', ', ' }}</a></small>{% endif %}
