...
<div style="background-color: #e5eeff; margin-left:20px; margin-top:20px; margin-right:20px;"><p style="font-size: 12px;><strong>Figure 1.</strong> This graphic showcases how all of the literacy domains of data advocacy are interrelated to each other, including each of the three primary domains in navy—Understanding Data, Processing Data, and Persuading with Data—as well as the subdomains beneath each one in red.</p></div><br>
